# Following lecture 7, implement example code for a book DAO
# Practising the REST API
# flask server that links to the bookDAO provided by the lecture Andre Beatty

from flask import Flask, request, jsonify, abort
from bookDAOskeleton import bookDAO  # Use relative import if the file is in the same directory
...
def create():
        ...
        # check the different fields of the books
